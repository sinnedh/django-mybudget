...
class OrganisationModelTests(BaseModelTests):
    ...
    def test_get_expenses(self):
        c1 = Category.all_objects.create(name='A category', organisation=self.o1)
        c2 = Category.all_objects.create(name='Another category', organisation=self.o2)
        e1_1 = Expense.all_objects.create(account=self.a1, category=c1, amount=1.1)
        e1_2 = Expense.all_objects.create(account=self.a1, category=c1, amount=1.2)
        e1_3 = Expense.all_objects.create(account=self.a1, category=c1, amount=1.3)
        e1_4 = Expense.all_objects.create(account=self.a2, category=c1, amount=1.4)
        e2_1 = Expense.all_objects.create(account=self.a3, category=c2, amount=2.1)
        e2_2 = Expense.all_objects.create(account=self.a3, category=c2, amount=2.2)
        e2_3 = Expense.all_objects.create(account=self.a4, category=c2, amount=2.3)
...
class CategoryModelTests(BaseModelTests):
    def test_get_expense_sum(self):
        c = Category.all_objects.create(name='Category 1', organisation=self.o1)
        Expense.all_objects.create(comment='Expense 1',
                               account=self.a1,
                               date=datetime.date(2014, 11, 11),
                               amount=99.99,
                               category=c)
        self.assertEqual(c.get_expense_sum(), decimal.Decimal('99.99'))
        Expense.all_objects.create(comment='Expense 2',
                               account=self.a1,
    ...
    def test_get_expense_sum_for_empty_category_with_empty_sub_categories(self):
        category = Category.all_objects.create(name='Super Category',
                                           organisation=self.o1)
        self.assertEqual(category.get_expense_sum(), 0.0)
        sub_category1 = Category.all_objects.create(name='Category 1',
                                                organisation=self.o1,
                                                super_category=category)
        sub_category2 = Category.all_objects.create(name='Category 2',
                                                organisation=self.o1,
                                                super_category=category)
    ...
    def test_get_expense_sum_for_category_with_sub_categories(self):
        category = Category.all_objects.create(name='Super Category',
                                           organisation=self.o1)
        expense1 = Expense.all_objects.create(comment='Expense 1',
                                          account=self.a1,
                                          date=datetime.date(2014, 11, 11),
                                          amount=11.11,
                                          category=category)
        ...
        sub_category2 = Category.all_objects.create(name='Category 2',
                                                organisation=self.o1,
                                                super_category=category)
        expense2 = Expense.all_objects.create(comment='Expense 2',
                                          account=self.a1,
                                          date=datetime.date(2014, 11, 11),
                                          amount=22.23,
                                          category=sub_category2)
        expense2 = Expense.all_objects.create(comment='Expense 3',
                                          account=self.a1,
                                          date=datetime.date(2014, 11, 11),
                                          amount=11.10,
                                          category=sub_category2)
    ...
    def test_get_expense_sum_for_empty_category_with_sub_categories(self):
        ...
        sub_category = Category.all_objects.create(name='Category 1',
                                               organisation=self.o1,
                                               super_category=category)
        expense1 = Expense.all_objects.create(comment='Expense 1',
                                          account=self.a1,
